                                ...
                                <div class="container" style="display:contents;">
                                    <form action="" autocomplete="off">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" placeholder="Enter name" id="sname" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary" style="margin-top: 10px" onclick="addstudent();">
                                          Submit
                                        </button>
                                    </div>
                                    </form>
